...
const DashboardEficienciaOperativa = () => {
    ...
    const requiredRoles = ['coordinator', 'manager']; // Solo coordinadores y gerentes pueden ver este reporte
            ...
            <div className="dashboard-container">
                ...
                <div style={{
                    ...
                    <p style={{ marginBottom: '2rem', color: '#6b7280' }}>
                        Este reporte está disponible solo para coordinadores y gerentes.
                    </p>
                    <button
