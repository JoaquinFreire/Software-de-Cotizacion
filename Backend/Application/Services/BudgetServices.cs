        ...
        public async Task CreateBudgetAsync(BudgetDTO budgetDto, List<Budget_ProductDTO> productDto, List<Budget_AccesoryDTO> accesoryDto)
        {
            ...
            var budget = new Budget
            {
                ...
                customer = new Customer
                {
                    ...
                    telephoneNumber = budgetDto.customer.telephoneNumber,
                    email = budgetDto.customer.email,
                ...
                {
                    name = budgetDto.workSpace.name,
                    address = budgetDto.workSpace.address,
                    workType = new WorkType
                    {
                        type = budgetDto.workSpace.workType.type
